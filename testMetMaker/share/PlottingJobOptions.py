...
algseq += CfgMgr.AthEventCounter()                                 #adds an instance of your alg to it
algseq += CfgMgr.PtPlottingAlg("UncalibratedPlottingAlg", Input = "Electrons", HistogramName = "elePt", RootStreamName = "HIST", RootDirName = "Uncalibrated")
#algseq += CfgMgr.PtPlottingAlg("UncalibratedPhotonPlottingAlg", Input = "Photon ", HistogramName = "photonPt", RootStreamName = "HIST", RootDirName = "Uncalibrated")
...
#svcMgr.THistSvc.Output += ["HIST DATAFILE='histPhoton-out.root' OPT='RECREATE'"] #add an output root file stream
