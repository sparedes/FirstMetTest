...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=testMetMaker -version=testMetMaker-00-00-00 -path=/home/paredes/TestArea/athenaMetTest2  -no_cleanup $* >${cmttestMetMakertempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=testMetMaker -version=testMetMaker-00-00-00 -path=/home/paredes/TestArea/athenaMetTest2  -no_cleanup $* >${cmttestMetMakertempfile}"
