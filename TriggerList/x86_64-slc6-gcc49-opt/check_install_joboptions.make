...
#cmt_local_tagfile_check_install_joboptions = $(TriggerList_tag)_check_install_joboptions.make
...
#cmt_local_tagfile_check_install_joboptions = $(TriggerList_tag).make
...
#cmt_final_setup_check_install_joboptions = $(bin)TriggerList_check_install_joboptionssetup.make
...
#cmt_final_setup_check_install_joboptions = $(bin)TriggerListsetup.make
cmt_local_check_install_joboptions_makefile = $(bin)check_install_joboptions.make
...
$(check_install_joboptionsactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/AthAnalysisBase/x86_64-slc6-gcc49-opt/2.4.25/AthAnalysisBase/2.4.25/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share *.py ' -installdir=/home/paredes/TestArea/athenaMetTest2/InstallArea/jobOptions/TriggerList -level=
