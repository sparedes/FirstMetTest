...
#cmt_local_tagfile = $(TriggerList_tag).make
cmt_local_tagfile = $(bin)$(TriggerList_tag).make
...
TriggerList_extratags = -tag_add=target_TriggerList
...
not_TriggerList_dependencies = { n=0; for p in $?; do m=0; for d in $(TriggerList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TriggerListdirs :
	@if test ! -d $(bin)TriggerList; then $(mkdir) -p $(bin)TriggerList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TriggerList
else
TriggerListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_TriggerList_makefile) : $(TriggerList_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerList.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerList_extratags) build constituent_config -out=$(cmt_local_TriggerList_makefile) TriggerList
else
$(cmt_local_TriggerList_makefile) : $(TriggerList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerList) ] || \
	  [ ! -f $(cmt_final_setup_TriggerList) ] || \
	  $(not_TriggerList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TriggerList.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerList_extratags) build constituent_config -out=$(cmt_local_TriggerList_makefile) TriggerList; \
	  fi
endif
...
$(cmt_local_TriggerList_makefile) : $(TriggerList_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerList.make"; \
	  $(cmtexe) -f=$(bin)TriggerList.in -tag=$(tags) $(TriggerList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TriggerList_makefile) TriggerList
else
$(cmt_local_TriggerList_makefile) : $(TriggerList_dependencies) $(cmt_build_library_linksstamp) $(bin)TriggerList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerList) ] || \
	  [ ! -f $(cmt_final_setup_TriggerList) ] || \
	  $(not_TriggerList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TriggerList_extratags) build constituent_makefile -out=$(cmt_local_TriggerList_makefile) TriggerList

TriggerList :: $(TriggerList_dependencies) $(cmt_local_TriggerList_makefile) dirs TriggerListdirs
	$(echo) "(constituents.make) Starting TriggerList"
	@if test -f $(cmt_local_TriggerList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_makefile) TriggerList; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerList_makefile) TriggerList
	$(echo) "(constituents.make) TriggerList done"

clean :: TriggerListclean ;

TriggerListclean :: $(TriggerListclean_dependencies) ##$(cmt_local_TriggerList_makefile)
	$(echo) "(constituents.make) Starting TriggerListclean"
	@-if test -f $(cmt_local_TriggerList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_makefile) TriggerListclean; \
	fi
	$(echo) "(constituents.make) TriggerListclean done"
#	@-$(MAKE) -f $(cmt_local_TriggerList_makefile) TriggerListclean

##	  /bin/rm -f $(cmt_local_TriggerList_makefile) $(bin)TriggerList_dependencies.make

install :: TriggerListinstall ;

TriggerListinstall :: $(TriggerList_dependencies) $(cmt_local_TriggerList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TriggerList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TriggerList_makefile) install
...
$(foreach d,$(TriggerList_dependencies),$(eval $(d)uninstall_dependencies += TriggerListuninstall))

TriggerListuninstall : $(TriggerListuninstall_dependencies) ##$(cmt_local_TriggerList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TriggerList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TriggerListuninstall ;
...
TriggerListConf_extratags = -tag_add=target_TriggerListConf
...
not_TriggerListConf_dependencies = { n=0; for p in $?; do m=0; for d in $(TriggerListConf_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TriggerListConfdirs :
	@if test ! -d $(bin)TriggerListConf; then $(mkdir) -p $(bin)TriggerListConf; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TriggerListConf
else
TriggerListConfdirs : ;
endif
...
ifndef QUICK
$(cmt_local_TriggerListConf_makefile) : $(TriggerListConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListConf.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListConf_extratags) build constituent_config -out=$(cmt_local_TriggerListConf_makefile) TriggerListConf
else
$(cmt_local_TriggerListConf_makefile) : $(TriggerListConf_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListConf) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListConf) ] || \
	  $(not_TriggerListConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TriggerListConf.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListConf_extratags) build constituent_config -out=$(cmt_local_TriggerListConf_makefile) TriggerListConf; \
	  fi
endif
...
$(cmt_local_TriggerListConf_makefile) : $(TriggerListConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListConf.make"; \
	  $(cmtexe) -f=$(bin)TriggerListConf.in -tag=$(tags) $(TriggerListConf_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TriggerListConf_makefile) TriggerListConf
else
$(cmt_local_TriggerListConf_makefile) : $(TriggerListConf_dependencies) $(cmt_build_library_linksstamp) $(bin)TriggerListConf.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListConf) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListConf) ] || \
	  $(not_TriggerListConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TriggerListConf_extratags) build constituent_makefile -out=$(cmt_local_TriggerListConf_makefile) TriggerListConf

TriggerListConf :: $(TriggerListConf_dependencies) $(cmt_local_TriggerListConf_makefile) dirs TriggerListConfdirs
	$(echo) "(constituents.make) Starting TriggerListConf"
	@if test -f $(cmt_local_TriggerListConf_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListConf_makefile) TriggerListConf; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListConf_makefile) TriggerListConf
	$(echo) "(constituents.make) TriggerListConf done"

clean :: TriggerListConfclean ;

TriggerListConfclean :: $(TriggerListConfclean_dependencies) ##$(cmt_local_TriggerListConf_makefile)
	$(echo) "(constituents.make) Starting TriggerListConfclean"
	@-if test -f $(cmt_local_TriggerListConf_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListConf_makefile) TriggerListConfclean; \
	fi
	$(echo) "(constituents.make) TriggerListConfclean done"
#	@-$(MAKE) -f $(cmt_local_TriggerListConf_makefile) TriggerListConfclean

##	  /bin/rm -f $(cmt_local_TriggerListConf_makefile) $(bin)TriggerListConf_dependencies.make

install :: TriggerListConfinstall ;

TriggerListConfinstall :: $(TriggerListConf_dependencies) $(cmt_local_TriggerListConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TriggerListConf_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListConf_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TriggerListConf_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(TriggerListConf_dependencies),$(eval $(d)uninstall_dependencies += TriggerListConfuninstall))

TriggerListConfuninstall : $(TriggerListConfuninstall_dependencies) ##$(cmt_local_TriggerListConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TriggerListConf_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListConf_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListConf_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TriggerListConfuninstall ;
...
TriggerList_python_init_extratags = -tag_add=target_TriggerList_python_init
...
not_TriggerList_python_init_dependencies = { n=0; for p in $?; do m=0; for d in $(TriggerList_python_init_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TriggerList_python_initdirs :
	@if test ! -d $(bin)TriggerList_python_init; then $(mkdir) -p $(bin)TriggerList_python_init; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TriggerList_python_init
else
TriggerList_python_initdirs : ;
endif
...
ifndef QUICK
$(cmt_local_TriggerList_python_init_makefile) : $(TriggerList_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerList_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerList_python_init_extratags) build constituent_config -out=$(cmt_local_TriggerList_python_init_makefile) TriggerList_python_init
else
$(cmt_local_TriggerList_python_init_makefile) : $(TriggerList_python_init_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerList_python_init) ] || \
	  [ ! -f $(cmt_final_setup_TriggerList_python_init) ] || \
	  $(not_TriggerList_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TriggerList_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerList_python_init_extratags) build constituent_config -out=$(cmt_local_TriggerList_python_init_makefile) TriggerList_python_init; \
	  fi
endif
...
$(cmt_local_TriggerList_python_init_makefile) : $(TriggerList_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerList_python_init.make"; \
	  $(cmtexe) -f=$(bin)TriggerList_python_init.in -tag=$(tags) $(TriggerList_python_init_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TriggerList_python_init_makefile) TriggerList_python_init
else
$(cmt_local_TriggerList_python_init_makefile) : $(TriggerList_python_init_dependencies) $(cmt_build_library_linksstamp) $(bin)TriggerList_python_init.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerList_python_init) ] || \
	  [ ! -f $(cmt_final_setup_TriggerList_python_init) ] || \
	  $(not_TriggerList_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TriggerList_python_init_extratags) build constituent_makefile -out=$(cmt_local_TriggerList_python_init_makefile) TriggerList_python_init

TriggerList_python_init :: $(TriggerList_python_init_dependencies) $(cmt_local_TriggerList_python_init_makefile) dirs TriggerList_python_initdirs
	$(echo) "(constituents.make) Starting TriggerList_python_init"
	@if test -f $(cmt_local_TriggerList_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_python_init_makefile) TriggerList_python_init; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerList_python_init_makefile) TriggerList_python_init
	$(echo) "(constituents.make) TriggerList_python_init done"

clean :: TriggerList_python_initclean ;

TriggerList_python_initclean :: $(TriggerList_python_initclean_dependencies) ##$(cmt_local_TriggerList_python_init_makefile)
	$(echo) "(constituents.make) Starting TriggerList_python_initclean"
	@-if test -f $(cmt_local_TriggerList_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_python_init_makefile) TriggerList_python_initclean; \
	fi
	$(echo) "(constituents.make) TriggerList_python_initclean done"
#	@-$(MAKE) -f $(cmt_local_TriggerList_python_init_makefile) TriggerList_python_initclean

##	  /bin/rm -f $(cmt_local_TriggerList_python_init_makefile) $(bin)TriggerList_python_init_dependencies.make

install :: TriggerList_python_initinstall ;

TriggerList_python_initinstall :: $(TriggerList_python_init_dependencies) $(cmt_local_TriggerList_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TriggerList_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_python_init_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TriggerList_python_init_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(TriggerList_python_init_dependencies),$(eval $(d)uninstall_dependencies += TriggerList_python_inituninstall))

TriggerList_python_inituninstall : $(TriggerList_python_inituninstall_dependencies) ##$(cmt_local_TriggerList_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TriggerList_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_python_init_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerList_python_init_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TriggerList_python_inituninstall ;
...
TriggerListConfDbMerge_extratags = -tag_add=target_TriggerListConfDbMerge
...
not_TriggerListConfDbMerge_dependencies = { n=0; for p in $?; do m=0; for d in $(TriggerListConfDbMerge_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TriggerListConfDbMergedirs :
	@if test ! -d $(bin)TriggerListConfDbMerge; then $(mkdir) -p $(bin)TriggerListConfDbMerge; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TriggerListConfDbMerge
else
TriggerListConfDbMergedirs : ;
endif
...
ifndef QUICK
$(cmt_local_TriggerListConfDbMerge_makefile) : $(TriggerListConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListConfDbMerge_extratags) build constituent_config -out=$(cmt_local_TriggerListConfDbMerge_makefile) TriggerListConfDbMerge
else
$(cmt_local_TriggerListConfDbMerge_makefile) : $(TriggerListConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListConfDbMerge) ] || \
	  $(not_TriggerListConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TriggerListConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListConfDbMerge_extratags) build constituent_config -out=$(cmt_local_TriggerListConfDbMerge_makefile) TriggerListConfDbMerge; \
	  fi
endif
...
$(cmt_local_TriggerListConfDbMerge_makefile) : $(TriggerListConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListConfDbMerge.make"; \
	  $(cmtexe) -f=$(bin)TriggerListConfDbMerge.in -tag=$(tags) $(TriggerListConfDbMerge_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TriggerListConfDbMerge_makefile) TriggerListConfDbMerge
else
$(cmt_local_TriggerListConfDbMerge_makefile) : $(TriggerListConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(bin)TriggerListConfDbMerge.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListConfDbMerge) ] || \
	  $(not_TriggerListConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TriggerListConfDbMerge_extratags) build constituent_makefile -out=$(cmt_local_TriggerListConfDbMerge_makefile) TriggerListConfDbMerge

TriggerListConfDbMerge :: $(TriggerListConfDbMerge_dependencies) $(cmt_local_TriggerListConfDbMerge_makefile) dirs TriggerListConfDbMergedirs
	$(echo) "(constituents.make) Starting TriggerListConfDbMerge"
	@if test -f $(cmt_local_TriggerListConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListConfDbMerge_makefile) TriggerListConfDbMerge; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListConfDbMerge_makefile) TriggerListConfDbMerge
	$(echo) "(constituents.make) TriggerListConfDbMerge done"

clean :: TriggerListConfDbMergeclean ;

TriggerListConfDbMergeclean :: $(TriggerListConfDbMergeclean_dependencies) ##$(cmt_local_TriggerListConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting TriggerListConfDbMergeclean"
	@-if test -f $(cmt_local_TriggerListConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListConfDbMerge_makefile) TriggerListConfDbMergeclean; \
	fi
	$(echo) "(constituents.make) TriggerListConfDbMergeclean done"
#	@-$(MAKE) -f $(cmt_local_TriggerListConfDbMerge_makefile) TriggerListConfDbMergeclean

##	  /bin/rm -f $(cmt_local_TriggerListConfDbMerge_makefile) $(bin)TriggerListConfDbMerge_dependencies.make

install :: TriggerListConfDbMergeinstall ;

TriggerListConfDbMergeinstall :: $(TriggerListConfDbMerge_dependencies) $(cmt_local_TriggerListConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TriggerListConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListConfDbMerge_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TriggerListConfDbMerge_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : TriggerListConfDbMergeuninstall

$(foreach d,$(TriggerListConfDbMerge_dependencies),$(eval $(d)uninstall_dependencies += TriggerListConfDbMergeuninstall))

TriggerListConfDbMergeuninstall : $(TriggerListConfDbMergeuninstall_dependencies) ##$(cmt_local_TriggerListConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TriggerListConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListConfDbMerge_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListConfDbMerge_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TriggerListConfDbMergeuninstall ;
...
TriggerListComponentsList_extratags = -tag_add=target_TriggerListComponentsList
...
not_TriggerListComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(TriggerListComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TriggerListComponentsListdirs :
	@if test ! -d $(bin)TriggerListComponentsList; then $(mkdir) -p $(bin)TriggerListComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TriggerListComponentsList
else
TriggerListComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_TriggerListComponentsList_makefile) : $(TriggerListComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListComponentsList_extratags) build constituent_config -out=$(cmt_local_TriggerListComponentsList_makefile) TriggerListComponentsList
else
$(cmt_local_TriggerListComponentsList_makefile) : $(TriggerListComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListComponentsList) ] || \
	  $(not_TriggerListComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TriggerListComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListComponentsList_extratags) build constituent_config -out=$(cmt_local_TriggerListComponentsList_makefile) TriggerListComponentsList; \
	  fi
endif
...
$(cmt_local_TriggerListComponentsList_makefile) : $(TriggerListComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListComponentsList.make"; \
	  $(cmtexe) -f=$(bin)TriggerListComponentsList.in -tag=$(tags) $(TriggerListComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TriggerListComponentsList_makefile) TriggerListComponentsList
else
$(cmt_local_TriggerListComponentsList_makefile) : $(TriggerListComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)TriggerListComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListComponentsList) ] || \
	  $(not_TriggerListComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TriggerListComponentsList_extratags) build constituent_makefile -out=$(cmt_local_TriggerListComponentsList_makefile) TriggerListComponentsList

TriggerListComponentsList :: $(TriggerListComponentsList_dependencies) $(cmt_local_TriggerListComponentsList_makefile) dirs TriggerListComponentsListdirs
	$(echo) "(constituents.make) Starting TriggerListComponentsList"
	@if test -f $(cmt_local_TriggerListComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListComponentsList_makefile) TriggerListComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListComponentsList_makefile) TriggerListComponentsList
	$(echo) "(constituents.make) TriggerListComponentsList done"

clean :: TriggerListComponentsListclean ;

TriggerListComponentsListclean :: $(TriggerListComponentsListclean_dependencies) ##$(cmt_local_TriggerListComponentsList_makefile)
	$(echo) "(constituents.make) Starting TriggerListComponentsListclean"
	@-if test -f $(cmt_local_TriggerListComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListComponentsList_makefile) TriggerListComponentsListclean; \
	fi
	$(echo) "(constituents.make) TriggerListComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_TriggerListComponentsList_makefile) TriggerListComponentsListclean

##	  /bin/rm -f $(cmt_local_TriggerListComponentsList_makefile) $(bin)TriggerListComponentsList_dependencies.make

install :: TriggerListComponentsListinstall ;

TriggerListComponentsListinstall :: $(TriggerListComponentsList_dependencies) $(cmt_local_TriggerListComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TriggerListComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TriggerListComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(TriggerListComponentsList_dependencies),$(eval $(d)uninstall_dependencies += TriggerListComponentsListuninstall))

TriggerListComponentsListuninstall : $(TriggerListComponentsListuninstall_dependencies) ##$(cmt_local_TriggerListComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TriggerListComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TriggerListComponentsListuninstall ;
...
TriggerListMergeComponentsList_extratags = -tag_add=target_TriggerListMergeComponentsList
...
not_TriggerListMergeComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(TriggerListMergeComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TriggerListMergeComponentsListdirs :
	@if test ! -d $(bin)TriggerListMergeComponentsList; then $(mkdir) -p $(bin)TriggerListMergeComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TriggerListMergeComponentsList
else
TriggerListMergeComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_TriggerListMergeComponentsList_makefile) : $(TriggerListMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_TriggerListMergeComponentsList_makefile) TriggerListMergeComponentsList
else
$(cmt_local_TriggerListMergeComponentsList_makefile) : $(TriggerListMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListMergeComponentsList) ] || \
	  $(not_TriggerListMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TriggerListMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_TriggerListMergeComponentsList_makefile) TriggerListMergeComponentsList; \
	  fi
endif
...
$(cmt_local_TriggerListMergeComponentsList_makefile) : $(TriggerListMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListMergeComponentsList.make"; \
	  $(cmtexe) -f=$(bin)TriggerListMergeComponentsList.in -tag=$(tags) $(TriggerListMergeComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TriggerListMergeComponentsList_makefile) TriggerListMergeComponentsList
else
$(cmt_local_TriggerListMergeComponentsList_makefile) : $(TriggerListMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)TriggerListMergeComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListMergeComponentsList) ] || \
	  $(not_TriggerListMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TriggerListMergeComponentsList_extratags) build constituent_makefile -out=$(cmt_local_TriggerListMergeComponentsList_makefile) TriggerListMergeComponentsList

TriggerListMergeComponentsList :: $(TriggerListMergeComponentsList_dependencies) $(cmt_local_TriggerListMergeComponentsList_makefile) dirs TriggerListMergeComponentsListdirs
	$(echo) "(constituents.make) Starting TriggerListMergeComponentsList"
	@if test -f $(cmt_local_TriggerListMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListMergeComponentsList_makefile) TriggerListMergeComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListMergeComponentsList_makefile) TriggerListMergeComponentsList
	$(echo) "(constituents.make) TriggerListMergeComponentsList done"

clean :: TriggerListMergeComponentsListclean ;

TriggerListMergeComponentsListclean :: $(TriggerListMergeComponentsListclean_dependencies) ##$(cmt_local_TriggerListMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting TriggerListMergeComponentsListclean"
	@-if test -f $(cmt_local_TriggerListMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListMergeComponentsList_makefile) TriggerListMergeComponentsListclean; \
	fi
	$(echo) "(constituents.make) TriggerListMergeComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_TriggerListMergeComponentsList_makefile) TriggerListMergeComponentsListclean

##	  /bin/rm -f $(cmt_local_TriggerListMergeComponentsList_makefile) $(bin)TriggerListMergeComponentsList_dependencies.make

install :: TriggerListMergeComponentsListinstall ;

TriggerListMergeComponentsListinstall :: $(TriggerListMergeComponentsList_dependencies) $(cmt_local_TriggerListMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TriggerListMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListMergeComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TriggerListMergeComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : TriggerListMergeComponentsListuninstall

$(foreach d,$(TriggerListMergeComponentsList_dependencies),$(eval $(d)uninstall_dependencies += TriggerListMergeComponentsListuninstall))

TriggerListMergeComponentsListuninstall : $(TriggerListMergeComponentsListuninstall_dependencies) ##$(cmt_local_TriggerListMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TriggerListMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListMergeComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListMergeComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TriggerListMergeComponentsListuninstall ;
...
TriggerList_optdebug_library_extratags = -tag_add=target_TriggerList_optdebug_library
...
not_TriggerList_optdebug_library_dependencies = { n=0; for p in $?; do m=0; for d in $(TriggerList_optdebug_library_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TriggerList_optdebug_librarydirs :
	@if test ! -d $(bin)TriggerList_optdebug_library; then $(mkdir) -p $(bin)TriggerList_optdebug_library; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TriggerList_optdebug_library
else
TriggerList_optdebug_librarydirs : ;
endif
...
ifndef QUICK
$(cmt_local_TriggerList_optdebug_library_makefile) : $(TriggerList_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerList_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerList_optdebug_library_extratags) build constituent_config -out=$(cmt_local_TriggerList_optdebug_library_makefile) TriggerList_optdebug_library
else
$(cmt_local_TriggerList_optdebug_library_makefile) : $(TriggerList_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerList_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_TriggerList_optdebug_library) ] || \
	  $(not_TriggerList_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TriggerList_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerList_optdebug_library_extratags) build constituent_config -out=$(cmt_local_TriggerList_optdebug_library_makefile) TriggerList_optdebug_library; \
	  fi
endif
...
$(cmt_local_TriggerList_optdebug_library_makefile) : $(TriggerList_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerList_optdebug_library.make"; \
	  $(cmtexe) -f=$(bin)TriggerList_optdebug_library.in -tag=$(tags) $(TriggerList_optdebug_library_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TriggerList_optdebug_library_makefile) TriggerList_optdebug_library
else
$(cmt_local_TriggerList_optdebug_library_makefile) : $(TriggerList_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(bin)TriggerList_optdebug_library.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerList_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_TriggerList_optdebug_library) ] || \
	  $(not_TriggerList_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TriggerList_optdebug_library_extratags) build constituent_makefile -out=$(cmt_local_TriggerList_optdebug_library_makefile) TriggerList_optdebug_library

TriggerList_optdebug_library :: $(TriggerList_optdebug_library_dependencies) $(cmt_local_TriggerList_optdebug_library_makefile) dirs TriggerList_optdebug_librarydirs
	$(echo) "(constituents.make) Starting TriggerList_optdebug_library"
	@if test -f $(cmt_local_TriggerList_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_optdebug_library_makefile) TriggerList_optdebug_library; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerList_optdebug_library_makefile) TriggerList_optdebug_library
	$(echo) "(constituents.make) TriggerList_optdebug_library done"

clean :: TriggerList_optdebug_libraryclean ;

TriggerList_optdebug_libraryclean :: $(TriggerList_optdebug_libraryclean_dependencies) ##$(cmt_local_TriggerList_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting TriggerList_optdebug_libraryclean"
	@-if test -f $(cmt_local_TriggerList_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_optdebug_library_makefile) TriggerList_optdebug_libraryclean; \
	fi
	$(echo) "(constituents.make) TriggerList_optdebug_libraryclean done"
#	@-$(MAKE) -f $(cmt_local_TriggerList_optdebug_library_makefile) TriggerList_optdebug_libraryclean

##	  /bin/rm -f $(cmt_local_TriggerList_optdebug_library_makefile) $(bin)TriggerList_optdebug_library_dependencies.make

install :: TriggerList_optdebug_libraryinstall ;

TriggerList_optdebug_libraryinstall :: $(TriggerList_optdebug_library_dependencies) $(cmt_local_TriggerList_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TriggerList_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_optdebug_library_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TriggerList_optdebug_library_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(TriggerList_optdebug_library_dependencies),$(eval $(d)uninstall_dependencies += TriggerList_optdebug_libraryuninstall))

TriggerList_optdebug_libraryuninstall : $(TriggerList_optdebug_libraryuninstall_dependencies) ##$(cmt_local_TriggerList_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TriggerList_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_optdebug_library_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerList_optdebug_library_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TriggerList_optdebug_libraryuninstall ;
...
TriggerListCLIDDB_extratags = -tag_add=target_TriggerListCLIDDB
...
not_TriggerListCLIDDB_dependencies = { n=0; for p in $?; do m=0; for d in $(TriggerListCLIDDB_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TriggerListCLIDDBdirs :
	@if test ! -d $(bin)TriggerListCLIDDB; then $(mkdir) -p $(bin)TriggerListCLIDDB; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TriggerListCLIDDB
else
TriggerListCLIDDBdirs : ;
endif
...
ifndef QUICK
$(cmt_local_TriggerListCLIDDB_makefile) : $(TriggerListCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListCLIDDB_extratags) build constituent_config -out=$(cmt_local_TriggerListCLIDDB_makefile) TriggerListCLIDDB
else
$(cmt_local_TriggerListCLIDDB_makefile) : $(TriggerListCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListCLIDDB) ] || \
	  $(not_TriggerListCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TriggerListCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListCLIDDB_extratags) build constituent_config -out=$(cmt_local_TriggerListCLIDDB_makefile) TriggerListCLIDDB; \
	  fi
endif
...
$(cmt_local_TriggerListCLIDDB_makefile) : $(TriggerListCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListCLIDDB.make"; \
	  $(cmtexe) -f=$(bin)TriggerListCLIDDB.in -tag=$(tags) $(TriggerListCLIDDB_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TriggerListCLIDDB_makefile) TriggerListCLIDDB
else
$(cmt_local_TriggerListCLIDDB_makefile) : $(TriggerListCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(bin)TriggerListCLIDDB.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListCLIDDB) ] || \
	  $(not_TriggerListCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TriggerListCLIDDB_extratags) build constituent_makefile -out=$(cmt_local_TriggerListCLIDDB_makefile) TriggerListCLIDDB

TriggerListCLIDDB :: $(TriggerListCLIDDB_dependencies) $(cmt_local_TriggerListCLIDDB_makefile) dirs TriggerListCLIDDBdirs
	$(echo) "(constituents.make) Starting TriggerListCLIDDB"
	@if test -f $(cmt_local_TriggerListCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListCLIDDB_makefile) TriggerListCLIDDB; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListCLIDDB_makefile) TriggerListCLIDDB
	$(echo) "(constituents.make) TriggerListCLIDDB done"

clean :: TriggerListCLIDDBclean ;

TriggerListCLIDDBclean :: $(TriggerListCLIDDBclean_dependencies) ##$(cmt_local_TriggerListCLIDDB_makefile)
	$(echo) "(constituents.make) Starting TriggerListCLIDDBclean"
	@-if test -f $(cmt_local_TriggerListCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListCLIDDB_makefile) TriggerListCLIDDBclean; \
	fi
	$(echo) "(constituents.make) TriggerListCLIDDBclean done"
#	@-$(MAKE) -f $(cmt_local_TriggerListCLIDDB_makefile) TriggerListCLIDDBclean

##	  /bin/rm -f $(cmt_local_TriggerListCLIDDB_makefile) $(bin)TriggerListCLIDDB_dependencies.make

install :: TriggerListCLIDDBinstall ;

TriggerListCLIDDBinstall :: $(TriggerListCLIDDB_dependencies) $(cmt_local_TriggerListCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TriggerListCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListCLIDDB_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TriggerListCLIDDB_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : TriggerListCLIDDBuninstall

$(foreach d,$(TriggerListCLIDDB_dependencies),$(eval $(d)uninstall_dependencies += TriggerListCLIDDBuninstall))

TriggerListCLIDDBuninstall : $(TriggerListCLIDDBuninstall_dependencies) ##$(cmt_local_TriggerListCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TriggerListCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListCLIDDB_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListCLIDDB_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TriggerListCLIDDBuninstall ;
...
cmt_local_tagfile_install_python_modules = $(bin)$(TriggerList_tag)_install_python_modules.make
...
cmt_local_tagfile_install_python_modules = $(bin)$(TriggerList_tag).make
...
cmt_TriggerListrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_TriggerListrchk_has_target_tag

cmt_local_tagfile_TriggerListrchk = $(bin)$(TriggerList_tag)_TriggerListrchk.make
cmt_final_setup_TriggerListrchk = $(bin)setup_TriggerListrchk.make
cmt_local_TriggerListrchk_makefile = $(bin)TriggerListrchk.make

TriggerListrchk_extratags = -tag_add=target_TriggerListrchk

else

cmt_local_tagfile_TriggerListrchk = $(bin)$(TriggerList_tag).make
cmt_final_setup_TriggerListrchk = $(bin)setup.make
cmt_local_TriggerListrchk_makefile = $(bin)TriggerListrchk.make

endif

not_TriggerListrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(TriggerListrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TriggerListrchkdirs :
	@if test ! -d $(bin)TriggerListrchk; then $(mkdir) -p $(bin)TriggerListrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TriggerListrchk
else
TriggerListrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_TriggerListrchk_makefile) : $(TriggerListrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListrchk_extratags) build constituent_config -out=$(cmt_local_TriggerListrchk_makefile) TriggerListrchk
else
$(cmt_local_TriggerListrchk_makefile) : $(TriggerListrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListrchk) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListrchk) ] || \
	  $(not_TriggerListrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TriggerListrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerListrchk_extratags) build constituent_config -out=$(cmt_local_TriggerListrchk_makefile) TriggerListrchk; \
	  fi
endif
...
$(cmt_local_TriggerListrchk_makefile) : $(TriggerListrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerListrchk.make"; \
	  $(cmtexe) -f=$(bin)TriggerListrchk.in -tag=$(tags) $(TriggerListrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TriggerListrchk_makefile) TriggerListrchk
else
$(cmt_local_TriggerListrchk_makefile) : $(TriggerListrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)TriggerListrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerListrchk) ] || \
	  [ ! -f $(cmt_final_setup_TriggerListrchk) ] || \
	  $(not_TriggerListrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TriggerListrchk_extratags) build constituent_makefile -out=$(cmt_local_TriggerListrchk_makefile) TriggerListrchk

TriggerListrchk :: $(TriggerListrchk_dependencies) $(cmt_local_TriggerListrchk_makefile) dirs TriggerListrchkdirs
	$(echo) "(constituents.make) Starting TriggerListrchk"
	@if test -f $(cmt_local_TriggerListrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListrchk_makefile) TriggerListrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListrchk_makefile) TriggerListrchk
	$(echo) "(constituents.make) TriggerListrchk done"

clean :: TriggerListrchkclean ;

TriggerListrchkclean :: $(TriggerListrchkclean_dependencies) ##$(cmt_local_TriggerListrchk_makefile)
	$(echo) "(constituents.make) Starting TriggerListrchkclean"
	@-if test -f $(cmt_local_TriggerListrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListrchk_makefile) TriggerListrchkclean; \
	fi
	$(echo) "(constituents.make) TriggerListrchkclean done"
#	@-$(MAKE) -f $(cmt_local_TriggerListrchk_makefile) TriggerListrchkclean

##	  /bin/rm -f $(cmt_local_TriggerListrchk_makefile) $(bin)TriggerListrchk_dependencies.make

install :: TriggerListrchkinstall ;

TriggerListrchkinstall :: $(TriggerListrchk_dependencies) $(cmt_local_TriggerListrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TriggerListrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TriggerListrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : TriggerListrchkuninstall

$(foreach d,$(TriggerListrchk_dependencies),$(eval $(d)uninstall_dependencies += TriggerListrchkuninstall))

TriggerListrchkuninstall : $(TriggerListrchkuninstall_dependencies) ##$(cmt_local_TriggerListrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TriggerListrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerListrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerListrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TriggerListrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(TriggerList_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(TriggerList_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_make = $(bin)$(TriggerList_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(TriggerList_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(TriggerList_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(TriggerList_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(TriggerList_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(TriggerList_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(TriggerList_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(TriggerList_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(TriggerList_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(TriggerList_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(TriggerList_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(TriggerList_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(TriggerList_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(TriggerList_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(TriggerList_tag).make
...
cmt_TriggerList_NICOS_Fix_debuginfo_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_TriggerList_NICOS_Fix_debuginfo_has_target_tag

cmt_local_tagfile_TriggerList_NICOS_Fix_debuginfo = $(bin)$(TriggerList_tag)_TriggerList_NICOS_Fix_debuginfo.make
cmt_final_setup_TriggerList_NICOS_Fix_debuginfo = $(bin)setup_TriggerList_NICOS_Fix_debuginfo.make
cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile = $(bin)TriggerList_NICOS_Fix_debuginfo.make

TriggerList_NICOS_Fix_debuginfo_extratags = -tag_add=target_TriggerList_NICOS_Fix_debuginfo

else

cmt_local_tagfile_TriggerList_NICOS_Fix_debuginfo = $(bin)$(TriggerList_tag).make
cmt_final_setup_TriggerList_NICOS_Fix_debuginfo = $(bin)setup.make
cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile = $(bin)TriggerList_NICOS_Fix_debuginfo.make

endif

not_TriggerList_NICOS_Fix_debuginfo_dependencies = { n=0; for p in $?; do m=0; for d in $(TriggerList_NICOS_Fix_debuginfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TriggerList_NICOS_Fix_debuginfodirs :
	@if test ! -d $(bin)TriggerList_NICOS_Fix_debuginfo; then $(mkdir) -p $(bin)TriggerList_NICOS_Fix_debuginfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TriggerList_NICOS_Fix_debuginfo
else
TriggerList_NICOS_Fix_debuginfodirs : ;
endif
...
ifndef QUICK
$(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) : $(TriggerList_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerList_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerList_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) TriggerList_NICOS_Fix_debuginfo
else
$(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) : $(TriggerList_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerList_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_TriggerList_NICOS_Fix_debuginfo) ] || \
	  $(not_TriggerList_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TriggerList_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(TriggerList_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) TriggerList_NICOS_Fix_debuginfo; \
	  fi
endif
...
$(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) : $(TriggerList_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building TriggerList_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -f=$(bin)TriggerList_NICOS_Fix_debuginfo.in -tag=$(tags) $(TriggerList_NICOS_Fix_debuginfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) TriggerList_NICOS_Fix_debuginfo
else
$(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) : $(TriggerList_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(bin)TriggerList_NICOS_Fix_debuginfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TriggerList_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_TriggerList_NICOS_Fix_debuginfo) ] || \
	  $(not_TriggerList_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TriggerList_NICOS_Fix_debuginfo_extratags) build constituent_makefile -out=$(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) TriggerList_NICOS_Fix_debuginfo

TriggerList_NICOS_Fix_debuginfo :: $(TriggerList_NICOS_Fix_debuginfo_dependencies) $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) dirs TriggerList_NICOS_Fix_debuginfodirs
	$(echo) "(constituents.make) Starting TriggerList_NICOS_Fix_debuginfo"
	@if test -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) TriggerList_NICOS_Fix_debuginfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) TriggerList_NICOS_Fix_debuginfo
	$(echo) "(constituents.make) TriggerList_NICOS_Fix_debuginfo done"

clean :: TriggerList_NICOS_Fix_debuginfoclean ;

TriggerList_NICOS_Fix_debuginfoclean :: $(TriggerList_NICOS_Fix_debuginfoclean_dependencies) ##$(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting TriggerList_NICOS_Fix_debuginfoclean"
	@-if test -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) TriggerList_NICOS_Fix_debuginfoclean; \
	fi
	$(echo) "(constituents.make) TriggerList_NICOS_Fix_debuginfoclean done"
#	@-$(MAKE) -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) TriggerList_NICOS_Fix_debuginfoclean

##	  /bin/rm -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) $(bin)TriggerList_NICOS_Fix_debuginfo_dependencies.make

install :: TriggerList_NICOS_Fix_debuginfoinstall ;

TriggerList_NICOS_Fix_debuginfoinstall :: $(TriggerList_NICOS_Fix_debuginfo_dependencies) $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : TriggerList_NICOS_Fix_debuginfouninstall

$(foreach d,$(TriggerList_NICOS_Fix_debuginfo_dependencies),$(eval $(d)uninstall_dependencies += TriggerList_NICOS_Fix_debuginfouninstall))

TriggerList_NICOS_Fix_debuginfouninstall : $(TriggerList_NICOS_Fix_debuginfouninstall_dependencies) ##$(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TriggerList_NICOS_Fix_debuginfo_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TriggerList_NICOS_Fix_debuginfouninstall ;
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(TriggerList_tag)_check_install_joboptions.make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(TriggerList_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_compile = $(bin)$(TriggerList_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(TriggerList_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(TriggerList_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(TriggerList_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(TriggerList_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(TriggerList_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(TriggerList_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(TriggerList_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(TriggerList_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(TriggerList_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(TriggerList_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(TriggerList_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(TriggerList_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(TriggerList_tag).make
